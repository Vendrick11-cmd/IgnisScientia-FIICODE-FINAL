...
onready var balloon := $ExampleBalloon/Balloon
onready var margin := $ExampleBalloon/Balloon/Margin
onready var character_label := $ExampleBalloon/Balloon/Margin/VBox/Character
onready var dialogue_label := $ExampleBalloon/Balloon/Margin/VBox/Dialogue
onready var responses_menu := $ExampleBalloon/Balloon/Margin/VBox/Responses
onready var response_template := $ExampleBalloon/ResponseTemplate
...
func _ready() -> void:
	...
	balloon.rect_min_size = Vector2(viewport_size.x * 0.55, 0)
	...
	dialogue_label.rect_size.x = balloon.rect_size.x /1.3
	...
	balloon.rect_global_position = Vector2((viewport_size.x - balloon.rect_size.x) * 0.51, viewport_size.y - balloon.rect_size.y - viewport_size.y * -0.1)
