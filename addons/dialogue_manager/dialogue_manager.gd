...
func show_example_dialogue_balloon(title: String, local_resource: DialogueResource = null, extra_game_states: Array = []) -> void:
	var portraits = preload("res://Misc/Dialogues/DialoguePortraits.tscn").instance()
	get_tree().current_scene.add_child(portraits)
	...
	if dialogue_line != null:
		...
		var balloon = preload("res://Misc/Dialogues/Dialogue.tscn").instance()
