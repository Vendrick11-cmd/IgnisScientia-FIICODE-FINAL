...
func _ready():
	...
	$RigidBody2D6.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D6.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D7.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D7.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D8.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D8.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D9.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D9.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D10.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D10.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D11.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D11.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D12.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D12.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D13.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D13.linear_velocity.y = rand_range(-40, -200)
	$RigidBody2D14.linear_velocity.x = rand_range(-200,200)
	$RigidBody2D14.linear_velocity.y = rand_range(-40, -200)
